...
function addDeliveryMan($data)
{
	...
	$branch_id = $data['branch_id'];
		...
		$sql = "INSERT INTO deliveryman(name, email, phone, nic, address, gender, password ,is_deleted, branch_id) VALUES('$name', '$email', '$phone', '$nic', '$address', '$gender', '$password', 0 , '$branch_id')";
		return mysqli_query($con, $sql);
